...
%       - aperture: Frustum angle in radians
%   - figHandle: Handle to the figure in which to plot
%   - imgSize: [height, width] of the image to fix subplot dimensions
%
% Example Usage:
%   personData = [1, 0, 0, pi/4; 2, 2, 1, pi/2];
%   frustum.length = 3;
%   frustum.aperture = pi/3;
%   fig = figure;
%   plotFrustums(personData, frustum, fig, [1080, 1920]);
