function [precision_results,recall_results, F1_results]=showResults( precisions,recalls,id )
...
for i=1:size(precisions,2)
    ...
    fprintf('F1: %d\n',f1);
    precision_results = mean(precisions(:,i));
    recall_results = mean(recalls(:,i));
    F1_results = f1;
end
