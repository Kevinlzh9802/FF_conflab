...
function worldXY_all = backProject(frame_data, K, R, t)
...
bodyHeight = 1.7;
height_ratios_map = struct('head', 1, 'nose', 0.95, ...
...
part_column_map = struct('head', [5,6], 'nose', [7,8], ...
    'leftShoulder', [9,10], 'rightShoulder', [11,12], ...
    'leftHip', [13,14], 'rightHip', [15,16], ...
    'leftFoot', [17,18], 'rightFoot', [19,20]);
